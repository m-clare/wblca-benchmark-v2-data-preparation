...
def clean_det(project_or_energy: str):
    ...
    if project_or_energy == "project":
        ...
        main_clean_logger.warning('project_or_energy can only have the inputs project or energy')
    ...
    dropdown_replacements = utils.read_yaml(
        dropdown_replacements_path)
    ...
    if replace_data:
        ...
        assert dtype_dict is not None, "The data types of the columns could not be read."
