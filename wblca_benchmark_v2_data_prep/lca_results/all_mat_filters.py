...
from wblca_benchmark_v2_data_prep.lca_results.enums import \
    MaterialQuantityOne, MaterialQuantityTwo
...
def create_all_oneclick_filters(df: pd.DataFrame) -> Dict[str, pd.Series]:
    ...
    filters = {
        ...
        'conc_wall_ele_cat_mat_two': df['Resource type'].str.fullmatch('Concrete wall elements'),
        'str_conc_cat_mat_two': df['Resource type'].str.contains(
            'Structural concrete (beams, columns, piling)',
            regex=False
        ),
        'cement_cat_mat_two': df['Resource type'].str.contains(
        ...
        'alumi_cat_mat_two': df['Resource type'].str.contains(
            'alumi|Alumi|ALUMI'
        ),
        ...
        'ceiling_cat_mat_three': df['Name'].str.contains(
            'ceiling|Ceiling|CEILING'
        ),
        'cladding_cat_mat_three': df['Name'].str.contains(
        ...
        'alumi_cat_mat_three': df['Name'].str.contains(
            'alumi|Alumi|ALUMI'
        ),
        ...
        'cmu_cat_mat_three': df['Name'].str.contains(
        ...
        'curtain_cat_mat_three': df['Name'].str.contains(
            'curtain|Curtain|CURTAIN'
        ),
        'door_cat_mat_two': df['Resource type'].str.contains('door|Door|DOOR'),
        'window_cat_mat_two': df['Resource type'].str.contains(
        ...
        'sandwich_cat_mat_three': df['Name'].str.contains(
        ...
        'wood_cat_mat_three': df['Name'].str.contains(
            'wood|Wood|WOOD'
        ),
        'lumber_cat_mat_three': df['Name'].str.contains(
            'lumber|Lumber|LUMBER'
        ),
        'timber_cat_mat_three': df['Name'].str.contains(
        ...
        'softwood_cat_mat_three': df['Name'].str.contains(
            'softwood|Softwood|SOFTWOOD'
        ),
        'plywood_cat_mat_three': df['Name'].str.contains(
            'plywood|Plywood|PLYWOOD'
        ),
        'hardwood_cat_mat_three': df['Name'].str.contains(
        ...
        'xps_cat_mat_three': df['Name'].str.contains(
            'XPS'
        ),
        'pir_cat_mat_three': df['Name'].str.contains(
            'PIR'
        ),
        'batt_cat_mat_three': df['Name'].str.contains(
            'batt|Batt|BATT'
        ),
        ...
        'cellulose_cat_mat_three': df['Name'].str.contains(
            'Cellulose'
        ),
        'eps_cat_mat_three': df['Name'].str.contains(
            'EPS'
        ),
        'spray_cat_mat_three': df['Name'].str.contains(
            'spray|Spray|SPRAY'
        ),
        'foam_cat_mat_three': df['Name'].str.contains(
            'foam|Foam|FOAM'
        ),

        # gypsum filters
        'gypsum_mq_one': df['MQ_1'].str.fullmatch(MaterialQuantityOne.GYPSUM.value, na=False),
        ...
        'glass_cat_mat_three': df['Name'].str.contains(
            'glass|Glass|GLASS',
            na=False
        ),
        ...
        'roof_cat_mat_three': df['Name'].str.contains(
            ' roof | Roof | ROOF '
        ),
        'roof_start_cat_mat_three': df['Name'].str.match(
            'roof|Roof|ROOF'
        ),
        'roofing_cat_mat_three': df['Name'].str.contains(
            ' roofing | Roofing | ROOFING '
        ),
        'roofing_start_cat_mat_three': df['Name'].str.match(
            'roofing|Roofing|ROOFING'
        ),
        ...
        'bitumen_cat_mat_three': df['Name'].str.contains(
        ...
        'asphalt_cat_mat_three': df['Name'].str.contains(
            'asphalt|Asphalt|ASPHALT'
        ),
        'shingle_cat_mat_three': df['Name'].str.contains(
            'shingle|Shingle|SHINGLE'
        ),

        # fireproofing filters
        'fireproof_mq_one': df['MQ_1'].str.fullmatch(MaterialQuantityOne.FIREPROOF.value),
        ...
        'spray_applied_cat_mat_three': df['Name'].str.contains(
            'spray-applied|Spray-applied|Spray-Applied',
            regex=False
        ),
        ...
        'revolving_cat_mat_three': df['Name'].str.contains('revolving|Revolving|REVOLVING'),
        ...
        # window filters
        'window_mq_one': df['MQ_1'].str.fullmatch(MaterialQuantityOne.WINDOW_FRAME.value),
        'window_cat_mat_three': df['Name'].str.contains('window|Window|WINDOW'),
        'part_sys_cat_mat_two': df['Resource type'].str.contains(
            'Partitioning systems (without windows)',
            regex=False
        ),
        'pvc_frame_window_cat_mat_two': df['Resource type'].str.contains('PVC frame windows'),
        'glass_fac_cat_mat_two': df['Resource type'].str.contains('Glass facades and glazing'),
        'aluminium_cat_mat_two': df['Resource type'].str.contains(
            'aluminium|Aluminium|ALUMINIUM',
        ),
        'unitized_cat_mat_three': df['Name'].str.contains(
        ...
        'suspen_cat_mat_three': df['Name'].str.contains(
            'suspen|Suspen|SUSPEN'
        ),
        'fiber_cat_mat_three': df['Name'].str.contains(
            'fiber|Fiber|FIBER'
        ),

        # cladding filters
        'cladding_mq_one': df['MQ_1'].str.fullmatch(MaterialQuantityOne.CLADDING.value),
        'formed_cat_mat_three': df['Name'].str.contains(
        ...
        'stucco_cat_mat_three': df['Name'].str.contains(
            'sutcco|Stucco|STUCCO'
        ),
        ...
        'adhes_seal_mq_one': df['MQ_1'].str.fullmatch(MaterialQuantityOne.ADHES_SEAL.value),
        ...
        'synth_comp_mq_one': df['MQ_1'].str.fullmatch(MaterialQuantityOne.SYNTH_COMP.value),
...
def create_all_tally_filters(df: pd.DataFrame) -> Dict[str, pd.Series]:
    ...
    filters = {
        ...
        'cip_cat_ele_four': df['Tally Entry Category'].str.fullmatch('Cast-in-place Concrete'),
        ...
        'precast_cat_ele_four': df['Tally Entry Category'].str.fullmatch('Precast Concrete'),
        'gfrc_cat_mat_three': df['Material Name'].str.contains(
            'gfrc|Gfrc|GFRC'
        ),
        ...
        'steel_cat_mat_four': df['Tally Entry Name'].str.contains(
            'steel|Steel|STEEL'
        ),
        ...
        'plate_cat_mat_four': df['Tally Entry Name'].str.contains(
            'plate|Plate|PLATE'
        ),
        ...
        'pr_conc_bm_cat_mat_four': df['Tally Entry Name'].str.fullmatch('Precast concrete beam'),
        ...
        'grout_cat_mat_three': df['Material Name'].str.contains(
            'grout|Grout|GROUT'
        ),
        ...
        'door_cat_mat_three': df['Material Name'].str.contains(
            'door|Door|DOOR'
        ),
        ...
        'extru_cat_mat_three': df['Material Name'].str.contains(
            'extru|Extru|EXTRU'
        ),
        'sheet_cat_mat_three': df['Material Name'].str.contains(
            'sheet|Sheet|SHEET'
        ),
        ...
        # wood filters
        'wood_mq_one': df['MQ_1'].str.fullmatch(MaterialQuantityOne.WOOD.value),
        'wood_cat_mat_two': df['Material Group'].str.contains(
            'wood|Wood|WOOD'
        ),
        'soft_cat_mat_three': df['Material Name'].str.contains(
            'soft|Soft|SOFT'
        ),
        ...
        'heavy_cat_mat_three': df['Material Name'].str.contains(
            'heavy|Heavy|HEAVY'
        ),
        ...
        'igu_cat_mat_four': df['Tally Entry Name'].str.contains(
            'IGU'
        ),
        'glass_cat_mat_three': df['Material Name'].str.contains(
            'glass|Glass|GLASS'
        ),
        ...
        'xps_cat_mat_three': df['Material Name'].str.contains(
            'XPS'
        ),
        'pir_cat_mat_three': df['Material Name'].str.contains(
            'PIR'
        ),
        ...
        'cellulose_cat_mat_three': df['Material Name'].str.contains(
            'Cellulose'
        ),
        'eps_cat_mat_three': df['Material Name'].str.contains(
            'EPS'
        ),
        'spray_cat_mat_three': df['Material Name'].str.contains(
            'Spray'
        ),
        'board_cat_mat_four': df['Tally Entry Name'].str.contains(
            'board|Board|BOARD'
        ),
        'low_cat_mat_three': df['Material Name'].str.contains(
            'low|Low|LOW'
        ),
        'high_cat_mat_three': df['Material Name'].str.contains(
            'high|High|HIGH'
        ),
        'ecose_cat_mat_three': df['Material Name'].str.contains(
            'ECOSE'
        ),
        'ddp_cat_mat_three': df['Material Name'].str.contains(
            'DDP'
        ),
        '115_cat_mat_three': df['Material Name'].str.contains(
            '115'
        ),
        '132_cat_mat_three': df['Material Name'].str.contains(
            '132'
        ),
        '135_cat_mat_three': df['Material Name'].str.contains(
            '135'
        ),
        '140_cat_mat_three': df['Material Name'].str.contains(
            '140'
        ),
        '432_cat_mat_three': df['Material Name'].str.contains(
            '432'
        ),
        ...
        'foil_facing_cat_mat_three': df['Material Name'].str.fullmatch(
            'Foil facing'
        ),
        ...
        'roof_cat_mat_three': df['Material Name'].str.contains(
            ' roof | Roof | ROOF '
        ),
        'roof_start_cat_mat_three': df['Material Name'].str.match(
            'roof|Roof|ROOF'
        ),
        ...
        'roof_start_cat_mat_four': df['Tally Entry Name'].str.match(
            'roof|Roof|ROOF'
        ),
        'insul_cat_mat_four': df['Tally Entry Name'].str.contains(
            'insul|Insul|INSUL'
        ),
        'sbs_cat_mat_three': df['Material Name'].str.contains(
            'SBS'
        ),
        ...
        'bur_cat_mat_three': df['Material Name'].str.contains(
            'BUR'
        ),
        'tpo_cat_mat_three': df['Material Name'].str.contains(
            'TPO'
        ),
        'epdm_cat_mat_three': df['Material Name'].str.contains(
            'EPDM'
        ),
        'PVC_cat_mat_three': df['Material Name'].str.contains(
            'PVC'
        ),
        ...
        'doors_and_frames_mq_one': df['MQ_1'].str.fullmatch(MaterialQuantityOne.DOOR_FRAME.value),
        'door_cat_mat_two': df['Material Group'].str.contains(
            'door|Door|DOOR'
        ),
        'door_frame_cat_mat_two': df['Material Group'].str.contains(
            'door frame|Door frame|Door Frame'
        ),
        'wood_cat_mat_three': df['Material Name'].str.contains(
            'wood|Wood|WOOD'
        ),
        'steel_cat_mat_three': df['Material Name'].str.contains(
            'steel|Steel|STEEL'
        ),
        ...
        'window_frame_mq_one': df['MQ_1'].str.fullmatch(MaterialQuantityOne.WINDOW_FRAME.value),
        ...
        'fiber_cat_mat_three': df['Material Name'].str.contains(
            'fiber|Fiber|FIBER'
        ),
        ...
        'zinc_cat_mat_three': df['Material Name'].str.contains(
            'zinc|Zinc|ZINC'
        ),
        'fiber_cem_cat_mat_three': df['Material Name'].str.contains(
            'fiber cement|Fiber cement|Fiber Cement'
        ),
        'gfrc_cat_mat_four': df['Tally Entry Name'].str.contains(
            'gfrc|Gfrc|GFRC'
        ),
        'panel_cat_mat_four': df['Tally Entry Name'].str.contains(
            'panel|Panel|PANEL'
        ),
        ...
        'paint_cat_mat_three': df['Material Name'].str.contains(
            'paint|Paint|PAINT'
        ),
        ...
        'vinyl_cat_mat_three': df['Material Name'].str.contains(
            'vinyl|Vinyl|VINYL'
        ),
        ...
        'other_metals_mq_one': df['MQ_1'].str.fullmatch(MaterialQuantityOne.OTH_METALS.value),
        'brass_cat_mat_three': df['Material Name'].str.contains(
            'brass|Brass|BRASS'
        ),
