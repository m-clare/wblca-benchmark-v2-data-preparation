...
class Ceilings(AbstractFilter):
    ...
    def filtering(
        ...
        self.and_or_loc(
            ...
            or_filters=[all_filters.get("ty_ed_04"), all_filters.get("ty_ed_03")],
        )
        return df
...
class Doors(AbstractFilter):
    ...
    def filtering(
        ...
        self.and_or_loc(
            ...
            or_filters=[all_filters.get("ty_en_igu"), all_filters.get("ty_en_ext")],
        )
        self.and_or_loc(
            df=df,
            result=OmniClassLevelOne.INTERIOR_CONSTRUCTION.value,
            ...
            or_filters=[all_filters.get("ty_en_int"), all_filters.get("ty_en_toilet")],
        )
        self.and_loc(
            df=df,
            result=OmniClassLevelOne.INTERIOR_FINISHES.value,
...
class Roofs(AbstractFilter):
    ...
    def filtering(
        ...
        self.and_or_loc(
            ...
            or_filters=[all_filters.get("ty_ec_alum"), all_filters.get("ty_ec_steel")],
        )
        self.and_or_loc(
            df=df,
            result=OmniClassLevelOne.ENCLOSURE.value,
...
class Walls(AbstractFilter):
    ...
    def filtering(
        ...
        self.and_or_loc(
            ...
            or_filters=[all_filters.get("rt_fn_shear"), all_filters.get("ty_ed_03")],
        )
        self.and_or_loc(
            df=df,
            result=OmniClassLevelOne.SUBSTRUCTURE.value,
        ...
        self.and_or_loc(
            ...
            or_filters=[all_filters.get("ty_ed_07"), all_filters.get("ty_ed_08")],
        )
        self.and_loc(
            df=df,
            result=OmniClassLevelOne.INTERIOR_FINISHES.value,
