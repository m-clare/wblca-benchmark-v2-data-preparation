...
class Mapper:
    ...
    def do_filtering(self) -> None:
        ...
        self.logger.info(
            "Filtering using the following class: %s",
            self._filter_type.__class__.__name__,
        )
    ...
    def write_csv(self, write_csv_path: Path):
        ...
        try:
            ...
            raise PermissionError(
                "Try closing the file you are trying to write to"
            ) from pe
    ...
    def write_pickle(self, write_pickle_path: Path):
        ...
        try:
            ...
            raise PermissionError(
                "Try closing the file you are trying to write into"
            ) from io
        return self
